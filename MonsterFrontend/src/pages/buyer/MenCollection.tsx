...
export default function MenCollection() {
  ...
  const handleQuickAdd = (product: WebsiteProduct) => {
    ...
    upsertItem({
      id: Math.abs(product.id.split('').reduce((a,b)=>{a=((a<<5)-a)+b.charCodeAt(0);return a&a},0)),
      name: product.name,
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-8"><BackButton to="/buyer" /><h1 className="text-3xl font-bold mt-4">Men Collection</h1></div>
